...
void PWM_Input_Conf(TIM_TypeDef * Timer,int Arr,int Psc) {
	...
	// On détecte des valeurs de compteurs entre 0 et 100. parce que le psc est 2/100
	// Or le signal PWM recu est mini a 1ms, et max a 2ms
	// donc on récupère une valeur de compteur mini a 50.
	// 1.5ms = pas d'entrée = CNT = 75 
